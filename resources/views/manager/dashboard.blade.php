                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <a class="text-heading font-semibold" href="{{ route('manager.lot.show',$bid->lot->id)}}" style="display: inline-block; width: 250px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"> {{$bid->lot->name}} </a>
                            </td>
                            <td>
